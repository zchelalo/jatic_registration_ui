...
export interface StudentRepository {
  listStudents(page: number, limit: number): Promise<Response<StudentEntity[]>>
  ...
  updateStudent(studentID: string, registrationNumber: string, password?: string): Promise<Response<string>>
